                                           ...
                                           card_products.length > 0 && (
                                               <div className='bg-white p-4 text-slate-600 flex flex-col gap-3'>
                                                   ...
                                                   <div className='flex gap-2'>
                                                       <input className='w-full px-3 py-2 border border-slate-200 outline-0 focus:border-green-300 rounded-sm' type='text' placeholder='Voucher coupon' />
                                                       <button className='bg-[#059473] text-white px-4 py-1 rounded-sm uppercase text-sm'>Apply</button>
                                                   </div>
                                                   <div className='flex justify-between items-center'>
                                                       <span>Total</span>
                                                       <span className='text-lg text-[#059473]'>$330</span>
                                                       <button className='px-5 py-[6px] rounded-sm hover:shadow-red-500/50 hover:shadow-lg bg-red-500 text-sm uppercase text-white'>Checkout</button>
                                                   </div>
                                               </div>
                                           )
                                       }
